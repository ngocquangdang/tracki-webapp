...
export const GET_OPTIMIZED_TRIP_REQUEST = 'Tracki/GET_OPTIMIZED_TRIP_REQUEST';
export const GET_OPTIMIZED_TRIP_SUCCEED = 'Tracki/GET_OPTIMIZED_TRIP_SUCCEED';
export const GET_OPTIMIZED_TRIP_FAILED = 'Tracki/GET_OPTIMIZED_TRIP_FAILED';
