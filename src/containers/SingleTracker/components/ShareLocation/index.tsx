...
function ShareLocation(props: Props) {
  ...
  const linkShareLocation = `https://app.tracki.com/public-map?token=${props.dataLink?.token}`;
  const codeShareLocation = `<iframe width="853" height="480" src="https://app.tracki.com/public-map?token=3hvdkd1qjjnj3qm7vlg9jmauj5${props.dataLink?.token} frameborder="0" allowfullscreen></iframe>`;
