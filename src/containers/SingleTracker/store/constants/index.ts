...
export const GET_CONTACT_ASSIGNED_REQUESTED =
  'Tracki/GET_CONTACT_ASSIGNED_REQUESTED';
export const GET_CONTACT_ASSIGNED_SUCCESSED =
  'Tracki/GET_CONTACT_ASSIGNED_SUCCESSED';
export const GET_CONTACT_ASSIGNED_FAILED = 'Tracki/GET_CONTACT_ASSIGNED_FAILED';

export const ADD_CONTACT_ASSIGNED_REQUESTED =
  'Tracki/ADD_CONTACT_ASSIGNED_REQUESTED';
export const ADD_CONTACT_ASSIGNED_SUCCESSED =
  'Tracki/ADD_CONTACT_ASSIGNED_SUCCESSED';
export const ADD_CONTACT_ASSIGNED_FAILED = 'Tracki/ADD_CONTACT_ASSIGNED_FAILED';

export const REMOVE_CONTACT_ASSIGNED_REQUESTED =
  'Tracki/REMOVE_CONTACT_ASSIGNED_REQUESTED';
export const REMOVE_CONTACT_ASSIGNED_SUCCESSED =
  'Tracki/REMOVE_CONTACT_ASSIGNED_SUCCESSED';
export const REMOVE_CONTACT_ASSIGNED_FAILED =
  'Tracki/REMOVE_CONTACT_ASSIGNED_FAILED';
